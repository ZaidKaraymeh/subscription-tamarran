...
import { Booking, BookingAction, BookingsInterface, OrderHistory, Sales, SubscribeAction, User, Users, VendorSettings, VendorSettingsAction, VenueSettings, VenueSettingsAction } from '../types';
  ...
  users: [
    {
      ...
      vendor_settings: {is_member: false, all_access: false},
    },
    {
      id: 2,
...
export const usersSlice = createSlice({
  ...
  reducers: {
    ...
    // saveVenuerSettings: (state, action: PayloadAction<VenueSettingsAction>) => {
    //   // console.log("ACTION ", action.payload)
    ...
    //   }
    //   const index = state.users.findIndex((x) => x.id == user.id);
    //   state.users[index].vendor_settings = new_venue_settings
    // }
